...
clippy.Agent = function(a, b, c) {
    ...
    moveTo: function(a, b, c) {
        var d = this._getDirection(a, b),
            e = "Move" + d;
        c === undefined && (c = 1e3), this._addToQueue(function(d) {
            if (c === 0) {
                this._el.css({
                    top: b,
                    left: a
    ...
    play: function(a, b, c) {
        return this.hasAnimation(a) ? (b === undefined && (b = 5e3), this._addToQueue(function(d) {
            var e = !1,
                f = function(a, b) {
    ...
    show: function(a) {
        ...
        if (this._el.css("top") === "auto" || !this._el.css("left") === "auto") {
            var b = $(window).width() * .8,
                c = ($(window).height() + $(document).scrollTop()) * .8;
            this._el.css({
                top: c,
                left: b
            })
    ...
    _step: function() {
        ...
        var a = Math.min(this._getNextAnimationFrame(), this._currentAnimation.frames.length - 1),
...
}, clippy.BASE_PATH = "./Agents/", clippy.load = function(a, b, c) {
